...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares .some(element => element.includes(squareNumber))) {
        ////this vairable retrieves the html element id that was clicked.
        ...
        checkWinConditions(drawWinLine);
...
function computersTurn() {
    ...
    let pickSquare;
    //this condition allows our while loop to keep trying if a square is seleceted already
    while(!success) {
...
function audio(audioURL) {
    //we create a new audio object and we pass the oath as a parameter 
...
//this line accesses our html canvas element
    ...
    //this line indictaes where the start of a lines x axis is
    let x1 = coordX1 ,
